...
CUDA_VISIBLE_DEVICES=0 python ../DeepCE/main_deepce.py --drug_file "../DeepCE/data/drugs_smiles.csv" \
...
--dropout 0.1 --batch_size 16 --max_epoch 100 > ../DeepCE/output/output.txt